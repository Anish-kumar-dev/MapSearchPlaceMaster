...
@interface AKCalloutMapAnnotationView()
...
@implementation AKCalloutMapAnnotationView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_isClearColor) {
        ...
        color = [[UIColor blackColor] colorWithAlphaComponent:06];
    }
    ...
    if (_isClearColor) {
        color = [[UIColor darkGrayColor] colorWithAlphaComponent:0.0];
    }else {
